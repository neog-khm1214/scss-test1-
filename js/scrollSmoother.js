  ...
  function ScrollSmoother(t) {
    ...
    bb(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? f
            ? F.to(o, { duration: k, scrollTop: n, overwrite: "auto", ease: $ })
            : E(n)
          : Va(n);
      }),
    ...
    V.forEach(function (e) {
      ...
      (i = Z.create({
        ...
        onRefresh: function onRefresh(e) {
          e.animation.invalidate(),
            ...
            N ||
              (d && (g = !1),
              e.animation.progress(F.utils.clamp(0, 1, u / A / -e.end))),
      ...
      Z.config(t),
      "scrollBehavior" in I.getComputedStyle(B) &&
        F.set([B, q], { scrollBehavior: "auto" }),
